            ...
            <div class="ibox ">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <button type="button" class="btn btn-sm btn-outline-secondary" href="{{ route('ripoti_b.download') }}"
                            onclick="event.preventDefault(); document.getElementById('download-form').submit();">
                            <i class="fa fa-file-import"></i> Export Data
                        </button>

                        <form id="download-form" action="{{ route('ripoti_b.download') }}" method="POST" class="d-none">
                            @csrf
                        </form>
